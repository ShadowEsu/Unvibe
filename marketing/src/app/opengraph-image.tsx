...
export const alt = "Unvibe — Built to teach you the code you vibe.";
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", maxWidth: 980 }}>
        <div style={{ color: "#6f45d2", fontSize: 18, fontWeight: 700, letterSpacing: 3, textTransform: "uppercase" }}>Built to teach you the code you vibe</div>
        <div style={{ display: "flex", flexDirection: "column", marginTop: 22, fontSize: 76, fontWeight: 750, lineHeight: .95, letterSpacing: -4 }}>
          <span>Vibe code fast.</span>
          <span style={{ color: "#6f45d2" }}>Learn the code you ship.</span>
        </div>
      </div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 21, color: "#655a70" }}>
        <span>You vibe-code it. Unvibe teaches you how it works.</span>
