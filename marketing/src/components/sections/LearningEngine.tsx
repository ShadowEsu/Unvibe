      ...
      <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
        ...
        >
          {signals.map((s) => (
            ...
            >
              <s.Icon size={19} className="text-primary" aria-hidden="true" />
              <h3 className="mt-3.5 text-fluid-base font-semibold text-fg">
                {s.title}
              </h3>
        ...
        >
          <div className="mb-6 flex items-center justify-between">
            ...
            <span className="rounded-pill bg-surface-2 px-3 py-0.5 font-mono text-[0.68rem] text-fg-faint">
              illustrative
            </span>
          </div>
          <div className="space-y-5">
            {concepts.map((c, i) => (
              <div key={c.name}>
                <div className="mb-2 flex items-center justify-between text-fluid-sm">
          ...
          <p className="mt-6 text-fluid-sm text-fg-muted">
