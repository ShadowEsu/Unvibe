...
const corePlans = [
  { id: "free", name: "Free", badge: "Public beta", eyebrow: "Understand the code in front of you.", price: "$0", detail: "30-day public beta: 50 AI explanations and 50 selected-code reviews. Included cloud models. No card or separate API key.", features: ["Selected-code explanations", "Core explanation levels", "Saved explanations and progress", "On-device secret filtering"], cta: "Download Unvibe", href: "/#install" },
  { id: "pro", name: "Pro", badge: "Individual", eyebrow: "Keep the context, not just the answer.", price: "$9/month", detail: "One developer account, billed monthly. Annual is $81/year (25% off).", features: ["File, diff, and project context", "Five explanation depths", "Follow-up and Test me", "Saved concepts, history, and study"], cta: "Join the Pro waitlist", href: "/?utm_campaign=pro_pricing#waitlist", featured: true },
