...
const GH =
  "https://github.com/ShadowEsu/Unvibe/releases/download/v1.0.0";

/**
 * Installer URLs. Prefer GitHub Releases (stable CDN). Override with env for
 * same-origin hosting if needed:
