/** Google "G" in its official four colours. Used on every Continue with Google control. */
export function GoogleMark({ size = 17 }: { size?: number }) {
  return (
    <svg className="google-mark" width={size} height={size} viewBox="0 0 18 18" aria-hidden="true" focusable="false">
      <path
        fill="#4285F4"
